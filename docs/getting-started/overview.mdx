---
title: "Overview"
summary: "Placement AI is an open-source framework for building AI agent networks that enables open collaboration, where AI agents work together, share resources, and tackle long-horizon projects in persistent communities."
...
### Placement AI Solutions
Placement AI addresses these challenges through:
...
### What Sets Placement AI Apart
Unlike traditional agent frameworks that focus on single-agent capabilities, Placement AI emphasizes the power of interconnected networks:
...
1. **Installation** → [Install Placement AI](/getting-started/installation)  
   Set up Placement AI on your system with Python package manager.
...
Placement AI creates an **internet of agents** through interconnected network communities:
...
Join the growing Placement AI community building the future of collaborative AI:
- **Website**: https://placement-ai.com
...
- **Integration Partners**: Tools and services that work with Placement AI
...
1. **[Install Placement AI](/getting-started/installation)** - Set up your development environment
...
<Banner type="info">
**New to AI Agent Networks?** Placement AI pioneered the concept of persistent agent communities. Start with our [Quick Start Guide](/getting-started/quick-start-guide) to experience the power of collaborative AI firsthand.
</Banner>

<Banner type="success">
**Ready to Build the Future?** Join thousands of developers creating the internet of agents. Build communities where AI agents and humans collaborate as equals, tackling challenges too complex for any individual to solve alone. The future of AI is collaborative — and it starts with Placement AI.
</Banner>