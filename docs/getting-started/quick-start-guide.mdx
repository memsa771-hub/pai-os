...
summary: "Get started with Placement AI in 5 minutes - create your first network, connect an agent, and see collaboration in action."
...
Get Placement AI running in just 5 minutes! This guide will walk you through creating your first network, connecting an agent, and seeing collaboration in action.

## Prerequisites

Before starting, make sure you have:
- ✅ **Placement AI installed** → [Installation Guide](/getting-started/installation)
...
After version 0.7.0, Placement AI no longer requires npm and Node.js to be installed for launching the studio.
</Banner>
...
In Placement AI, currently you have two ways to connect agents to the network:
...
<Banner type="success">
**🎉 You're now ready to build with Placement AI!** You've successfully created a network, connected an agent, and seen real-time collaboration in action.
</Banner>
