...
Placement AI provides powerful LLM integration capabilities, allowing you to create AI-powered agents that can understand natural language, generate intelligent responses, and interact dynamically with users and other agents.
...
Placement AI supports multiple LLM providers out of the box:
