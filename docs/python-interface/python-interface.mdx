...
summary: "Complete guide to the Placement AI Python API. Learn WorkerAgent patterns, workspace interface, LLM integration, and advanced agent programming."
...
The Placement AI Python API provides powerful abstractions for building intelligent agents that can collaborate in networks. This guide covers everything from basic agent creation to advanced programming patterns.

## Agent Programming Models

Placement AI offers two main approaches for building agents:
...
<Banner type="info">
**Pro Tip:** The Placement AI Python API is designed for both simple use cases and complex multi-agent systems. Start simple with WorkerAgent and gradually add sophistication as your needs grow.
</Banner>