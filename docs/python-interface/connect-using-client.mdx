...
summary: "Learn to connect agents to Placement AI networks using AgentClient - low-level connection management, message handling, and network interaction."
...
Learn how to connect agents to Placement AI networks using the low-level `AgentClient` class. This provides direct control over network connections, message handling, and event processing.

## AgentClient Overview

The `AgentClient` class provides the foundation for connecting agents to Placement AI networks:
