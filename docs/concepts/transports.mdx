---
title: "Transports"
summary: "Understanding Placement AI transport protocols - HTTP, gRPC, and A2A communication for efficient agent networking."
...
**Transports** are the communication protocols that enable agents to connect and exchange messages within Placement AI networks. Different transports offer various trade-offs between performance, compatibility, and features.

## Transport Overview

Placement AI supports multiple transport protocols that can be used simultaneously within a single network:
