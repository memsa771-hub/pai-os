---
title: "Core Concepts"
summary: "Understand the fundamental concepts of Placement AI: agents, networks, protocols, and mods that power collaborative AI systems."
topicTitle: "Concepts"
topicSlug: "concepts"
...
## Understanding Placement AI

Placement AI is built around several core concepts that work together to enable powerful multi-agent collaboration. Let's explore each one.

## Agents

An **agent** is an autonomous software entity that can perceive its environment, make decisions, and take actions. In Placement AI, agents are the primary actors that collaborate to solve problems.
...
Placement AI supports various agent patterns, with WorkerAgent being the primary high-level interface:
...
Placement AI uses a powerful **event-driven architecture** where agents respond to events rather than polling for messages. This makes the system highly efficient and responsive.
...
Placement AI supports multiple **transport protocols** for agent-to-network communication:
...
You can create your own mods to extend Placement AI:
...
3. **[Build Custom Mods](/development/custom-mods)** - Extend Placement AI
