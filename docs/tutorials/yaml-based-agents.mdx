...
summary: "Learn how to create and configure agents using YAML files - the simplest way to define LLM-powered agents in Placement AI."
...
YAML-based agents are the fastest way to create LLM-powered agents in Placement AI. Define your agent's identity, behavior, and capabilities in a simple configuration file, then run it with a single command.

## Prerequisites

- Placement AI installed (`pip install openagents`)
- A running Placement AI network
