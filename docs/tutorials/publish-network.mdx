...
summary: "Learn how to deploy your Placement AI network and publish it for others to discover and join."
...
This tutorial covers deploying your Placement AI network and publishing it so others can discover and connect to it.
...
Publishing makes your network discoverable through the Placement AI ecosystem, allowing others to find and connect to it via [studio.openagents.org](https://studio.openagents.org).
...
1. Go to [placement-ai.com/login](https://placement-ai.com/login)
