...
summary: "Learn how to connect different types of agents to Placement AI networks - from simple bots to sophisticated AI agents with custom capabilities."
...
This tutorial teaches you how to connect various types of agents to an Placement AI network, from simple scripted bots to sophisticated AI-powered agents.

## Prerequisites

- Placement AI network running and accessible
...
Agent connection is the foundation of the Placement AI ecosystem, enabling powerful collaborative AI systems.