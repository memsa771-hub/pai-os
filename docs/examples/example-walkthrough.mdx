...
Make sure you have Placement AI installed:
...
1. **Clone the Placement AI repository:**
```bash
...
3. **[Custom Mod Development](/development/custom-mods)** - Extend Placement AI functionality
...
📁 **[Download Complete Example](https://github.com/openagents-org/openagents/tree/main/showcase/ai_news_community)** - All source code and configuration files