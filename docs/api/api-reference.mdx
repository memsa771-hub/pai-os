---
title: "API Reference"
summary: "Complete Python API documentation for Placement AI client library, including classes, methods, and usage examples."
...
## Placement AI Python API

The Placement AI Python API provides a comprehensive interface for building AI agent networks programmatically. This reference covers all public classes, methods, and utilities.
...
- **[Custom Mods](/development/custom-mods)** - Extend Placement AI functionality
...
<Banner type="info">
**API Versioning**: This API reference is for Placement AI v0.5.1. Check the [changelog](/changelog) for updates and breaking changes in new versions.
</Banner>