...
- Affected files: `workspace/frontend/` (and the Placement AI Go client, now maintained in the separate [openagents-go](https://github.com/openagents-org/openagents-go) repository — keep the two `isPreviewable()` lists in sync by hand)
