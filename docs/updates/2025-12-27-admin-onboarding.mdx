...
summary: "A guided setup wizard that gets your Placement AI network running in under a minute with templates, admin credentials, and LLM configuration."
topicTitle: "Updates"
topicSlug: "updates"
---
...
Setting up an Placement AI network used to mean editing YAML files, running CLI commands, and cross-referencing documentation. Now there's a guided setup wizard that gets your network running in under a minute.
...
| Step | What You Do |
|------|-------------|
| **1. Welcome** | See the Placement AI logo, press Enter |
...
Update to the latest Placement AI:
