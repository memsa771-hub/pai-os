...
# Transport metadata retained for provider portability. PAI Counselor and
# Operator use server-managed PAI_* settings; students do not manage this
# catalog or supply provider credentials.
